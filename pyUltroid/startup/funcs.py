...
async def autobot():
    ...
    if who.username:
        ...
        username = "Honey_" + (str(who.id))[5:] + "_bot"
    bf = "@BotFather"
    ...
    if isdone.startswith("Sorry,"):
        ran = randint(1, 100)
        username = "honey" + (str(who.id))[6:] + str(ran) + "_bot"
        await ultroid_bot.send_message(bf, username)
        await asyncio.sleep(1)
        isdone = (await ultroid_bot.get_messages(bf, limit=1))[0].text
...
async def customize():
    ...
    try:
        ...
        file = random.choice(
            [
                "https://envs.sh/kK3.png",
                "https://envs.sh/kKC.png",
        ...
        await ultroid_bot.send_message(
            "botfather",
            f"✨ Powerful Honey Assistant Bot ✨\n✨ Master ~ {sir} ✨\n\n✨ Powered By ~ @H0NEYSINGH ✨",
        )
        await asyncio.sleep(2)
